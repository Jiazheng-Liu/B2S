...
parser.add_argument(
    ...
    choices=[
        ...
        "pg5_25_5_25", "pg5_25_25_50", "pg25_50_25_50", "pg0.01+0.02",
        "pg0.05+0.02", "pg0.1+0.02"
    ],
)
...
for epoch in range(epoch_init, opt.n_epoch + 1):
    ...
    for ii, clean in enumerate(TrainingLoader):
        ...
        # ordivk
        # 13r21_ordiv2_1.5e-4 | 15r21_ordiv2_1e-4
        k = 2.  # 1. || 2.
        mu_m = mu_x / k + mu_x.detach() * (1 - 1 / k) + (
            mu_e - mu_x.detach()) * beta / (1 + beta)
        ...
        for valid_name, valid_images in valid_dict.items():
            ...
            for idx, im in enumerate(valid_images):
                ...
                with torch.no_grad():
                    ...
                    sigma_n = calc_noise_var(est_map, mu_e.detach(),
                                             noise_type)
            ...
            with open(log_path, "a") as f:
                f.writelines("epoch:{}, mu_e:{:.3f}/{:.4f}, pme_e:{:.3f}/{:.4f}\n".format(
                    epoch,
                    avg_psnr_mu_e,
                    avg_ssim_mu_e,
                    avg_psnr_pme_e,
